...
<![endif]-->
      ...
      <div class="container">
        <div class="row">
          <div class="navbar-header col-md-8">
            <button type="button" class="navbar-toggle navbar-brand" toggle="collapse" target=".navbar-ex1-collapse">
              <span class="sr-only">Menu</span>
              <span class="icon-bar">1</span>
              <span class="icon-bar">2</span>
              <span class="icon-bar">3</span>
            </button>
            <a class="navbar-brand" href="#/CreateTeam" rel="home" title="Practice Session for AngularJS">Create Team</a> 
          </div>
  ...
  <script src="app/teamCtrl.js"></script>
</html>
